...
<div style="padding: 3px;">  
 ...
 <?php
    ...
    while($row = mysqli_fetch_assoc($result)){
     ...
     if($row['username']==$user && $subject==$row['subject'] && $semester==$row['semester'] && $section==$row['section'])
     {       
      ?>  
      <tr>  
       ...
       <td><input type="button" name="view" value="Action" id="<?php echo $row["section_name"]; ?>"  /></td>  
     </tr>  
     <?php  
   }
